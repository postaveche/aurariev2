...
@section('content')
    <div class="wrapper">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body table-responsive p-0">
                                    <table class="table table-striped table-valign-middle">
                                        ...
                                        <tr>
                                            <td>
                                                <img src="admin/img/default-150x150.png" alt="Product 1" class="img-circle img-size-32 mr-2">
                                                Some Product
                                            </td>
                                            <td>$13 USD</td>
                                            <td>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2023-2024 <a href="https://aurarie.md/">Net.ART</a>.</strong>
            All rights reserved.
